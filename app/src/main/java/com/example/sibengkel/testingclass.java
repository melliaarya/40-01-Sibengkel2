...
//                    intent = new Intent(com.example.sibengkel.MainActivity.this, BookingList.class);
...
//                @Override
//                public void onClick(View v) {
//                    intent = new Intent(com.example.sibengkel.MainActivity.this, SettingActivity.class);
//                    startActivity(intent);
//                }
//            });
//
...
//            intent = new Intent(com.example.sibengkel.MainActivity.this, ScheduleActivity.class);
//            intent.putExtra("email", getIntent().getExtras().get("email").toString());
//            startActivity(intent);
//        }
//
